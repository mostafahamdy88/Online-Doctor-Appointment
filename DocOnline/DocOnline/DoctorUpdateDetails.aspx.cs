...
namespace DocOnline
{
    public partial class DoctorUpdateDetails : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Update Doctor set DocType='" + SpecialityId + "',DocName='" + TextBox1.Text + "',DocGender='" + Gender + "',DocPhone='" + TextBox4.Text + "'where DocId='" + Session["id"].ToString() + "'", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
